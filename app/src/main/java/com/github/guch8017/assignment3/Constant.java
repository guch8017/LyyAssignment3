...
public class Constant {
    ...
    public static final String JS_REMOVE_ELEMENTS =
            ...
            "var ic_usr = document.getElementsByClassName('icon icon-user2')[0];if(ic_usr != null){ic_usr.remove();}" +
    ...
    public static final String JS_MENU_CLICK =
            "javascript: (function(){document.getElementsByClassName('icon icon-menu3')[0].click();})()";
}
